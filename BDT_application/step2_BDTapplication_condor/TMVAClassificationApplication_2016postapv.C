...
TH1F* Getoutput( TString myMethodList = "", std::string input_name="",float xs=1.0, float eff_N=1.0, std::string weight_name="", string mass_scan="", string channel="", string type_="", string cp="")
{
   ...
   if (weight_name=="nominal_noctag")
    {string name_temp="ttcYEAR_"+input_name+"_nominal_noctag";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="central")
    {string name_temp="ttcYEAR_"+input_name;
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="pileup_up")
    {string name_temp="ttcYEAR_"+input_name+"_pileupUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="pileup_down")
    {string name_temp="ttcYEAR_"+input_name+"_pileupDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="prefire_up")
    {string name_temp="ttcYEAR_"+input_name+"_prefireUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="prefire_down")
    {string name_temp="ttcYEAR_"+input_name+"_prefireDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="muID_sysup")
    {string name_temp="ttcYEAR_"+input_name+"_muIDYEARsysUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="muID_sysdown")
    {string name_temp="ttcYEAR_"+input_name+"_muIDYEARsysDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="muID_statup")
    {string name_temp="ttcYEAR_"+input_name+"_muIDYEARstatUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="muID_statdown")
    {string name_temp="ttcYEAR_"+input_name+"_muIDYEARstatDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="eleID_sysup")
    {string name_temp="ttcYEAR_"+input_name+"_eleIDYEARsysUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="eleID_sysdown")
    {string name_temp="ttcYEAR_"+input_name+"_eleIDYEARsysDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="eleID_statup")
    {string name_temp="ttcYEAR_"+input_name+"_eleIDYEARstatUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="eleID_statdown")
    {string name_temp="ttcYEAR_"+input_name+"_eleIDYEARstatDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="lumi_up")
    {string name_temp="ttcYEAR_"+input_name+"_lumiYEARUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="lumi_down")
    {string name_temp="ttcYEAR_"+input_name+"_lumiYEARDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="trigger_up")
    {
    string name_temp="";
    if(channel=="ee"){name_temp="ttcYEAR_"+input_name+"_dieleTriggerYEARUp";}
    if(channel=="em"){name_temp="ttcYEAR_"+input_name+"_elemuTriggerYEARUp";}
    if(channel=="mm"){name_temp="ttcYEAR_"+input_name+"_dimuTriggerYEARUp";}
    if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
    if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
    histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="trigger_down")
    {
    string name_temp="";
    if(channel=="ee"){name_temp="ttcYEAR_"+input_name+"_dieleTriggerYEARDown";}
    if(channel=="em"){name_temp="ttcYEAR_"+input_name+"_elemuTriggerYEARDown";}
    if(channel=="mm"){name_temp="ttcYEAR_"+input_name+"_dimuTriggerYEARDown";}
    if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
    if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
    histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="charFlip_SFup")
    {string name_temp="ttcYEAR_"+input_name+"_chargeflipYEARUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="charFlip_SFdo")
    {string name_temp="ttcYEAR_"+input_name+"_chargeflipYEARDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="sig_pdfup")
    {string name_temp="ttcYEAR_"+input_name+"_sigYEARpdfUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="sig_pdfdo")
    {string name_temp="ttcYEAR_"+input_name+"_sigYEARpdfDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="sig_scaleup")
    {string name_temp="ttcYEAR_"+input_name+"_sigYEARscaleUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="sig_scaledo")
    {string name_temp="ttcYEAR_"+input_name+"_sigYEARscaleDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="sig_psup")
    {string name_temp="ttcYEAR_"+input_name+"_sigYEARpsUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="sig_psdo")
    {string name_temp="ttcYEAR_"+input_name+"_sigYEARpsDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   ...
   if (weight_name=="ctag_statup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARstatUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_statdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARstatDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_EleIDup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEAREleIDUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_EleIDdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEAREleIDDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_LHEScaleWeightmuFup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARLHEmuFUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_LHEScaleWeightmuFdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARLHEmuFDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_LHEScaleWeightmuRup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARLHEmuRUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_LHEScaleWeightmuRdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARLHEmuRDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_MuIDup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARmuIDUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_MuIDdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARmuIDDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_PSWeightFSRup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARPSFSRUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_PSWeightFSRdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARPSFSRDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_PUWeightup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARPUUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_PUWeightdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagYEARPUDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_DYJetsup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagDYXSUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_DYJetsdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagDYXSDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_STup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagSTXSUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_STdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagSTXSDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_VVup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagVVXSUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_VVdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagVVXSDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_WJetsup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagWJetXSUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_WJetsdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagWJetXSDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_ttbarup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagTTXSUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_XSec_ttbardo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagTTXSDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_jerup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagJERUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_jerdo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagJERDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_jesTotalup")
    {string name_temp="ttcYEAR_"+input_name+"_ctagJESUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (weight_name=="ctag_jesTotaldo")
    {string name_temp="ttcYEAR_"+input_name+"_ctagJESDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
...
TH1F* Getoutput_sys( TString myMethodList = "", std::string input_name="",float xs=1.0, float eff_N=1.0, std::string system_unc="", string mass_scan="", string channel="", string type_="", string cp="")
{
   ...
   if (system_unc=="jesup")
    {string name_temp="ttcYEAR_"+input_name+"_jesYEARUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (system_unc=="jesdo")
    {string name_temp="ttcYEAR_"+input_name+"_jesYEARDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (system_unc=="jerup")
    {string name_temp="ttcYEAR_"+input_name+"_jerYEARUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (system_unc=="jerdo")
    {string name_temp="ttcYEAR_"+input_name+"_jerYEARDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (system_unc=="unclusterEup")
    {string name_temp="ttcYEAR_"+input_name+"_metYEARunclusterEUp";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
   if (system_unc=="unclusterEdo")
    {string name_temp="ttcYEAR_"+input_name+"_metYEARunclusterEDown";
     if (input_name.find("ttc_a")!= string::npos) name_temp.replace(15,5,"TAToTTQ");
     if (input_name.find("ttc_s0")!= string::npos) name_temp.replace(15,6,"TS0ToTTQ");
     histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
    }
...
TH1F* Getoutput_fake_mc( TString myMethodList = "", std::string input_name="",float xs=1.0, float eff_N=1.0, std::string weight_name="", string mass_scan="", string channel="", string type_="", string cp="")
{
   ...
   std::cout << "==> TMVAClassificationApplication is done!" << std::endl << std::endl;
   string name_temp="ttcYEAR_"+input_name+"_fake";
   histBdtG->SetNameTitle(name_temp.c_str(),name_temp.c_str());
...
int TMVAClassificationApplication()
{
   ...
   string sample_path="/eos/cms/store/group/phys_top/ExtraYukawa/2016postapvMerged/";
   ...
   //samples.push_back("tttW"); //not present for 2016postapv
   samples.push_back("tttt");
   samples.push_back("tZq");
   samples.push_back("www1");
   samples.push_back("DYnlo");
   samples.push_back("wwz1");
   samples.push_back("ww");
   samples.push_back("wz_qcd");
   samples.push_back("wzz1");
   samples.push_back("zzz1");
   ...
   xss.push_back(6077.22);//DYnlo
   xss.push_back(0.1707);//WWZ
   xss.push_back(11.09);//WW
   ...
   for(int i=0;i<samples.size();i++){ 
     ...
     if (i<10)eff_N.push_back(0.5*ttemp->GetBinContent(1));//half of the events are used for BDT training
